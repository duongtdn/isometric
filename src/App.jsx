  ...
  return (
    <div className = "container">
      ...
      <div className="w3-bar w3-border w3-border-gray w3-round" style = {{margin: "8px 0"}}>
        <button className="w3-button w3-bar-item" onClick = {e => setPen("pencil")}>Draw</button>
        <button className="w3-button w3-bar-item" onClick = {e => setPen("eraser")}>Eraser</button>
      </div>
